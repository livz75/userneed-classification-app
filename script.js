...
const MODELS = [
    ...
    { id: 'anthropic/claude-opus-4.6',                  provider: 'Anthropic', name: 'Claude Opus 4.6',        speed: '⚡ Modéré',         input: 5.00,  output: 25.00, quality: 5, french: 3, recommended: true,  note: 'Modèle le plus puissant Anthropic, raisonnement avancé' },
    ...
    { id: 'google/gemini-3.1-pro-preview',              provider: 'Google',    name: 'Gemini 3.1 Pro',         speed: '⚡⚡ Rapide',        input: 2.00,  output: 12.00, quality: 5, french: 3, recommended: true,  note: 'Dernière génération Gemini Pro, qualité supérieure' },
    ...
    { id: 'openai/gpt-5.4',                             provider: 'OpenAI',    name: 'GPT-5.4',                speed: '⚡ Modéré',         input: 2.50,  output: 15.00, quality: 5, french: 3, recommended: true,  note: 'Modèle phare OpenAI, qualité maximale' },
    { id: 'openai/gpt-5.4-mini',                        provider: 'OpenAI',    name: 'GPT-5.4 Mini',           speed: '⚡⚡ Rapide',        input: 0.75,  output: 4.50,  quality: 5, french: 3, recommended: true,  note: 'Dernière génération GPT-5, compact et performant' },
    ...
    { id: 'mistralai/mistral-small-24b-instruct-2501',  provider: 'Mistral',   name: 'Mistral Small 3.1',      speed: '⚡⚡ Rapide',        input: 0.05,  output: 0.08,  quality: 4, french: 3, recommended: true,  note: 'Modèle européen, excellent en français' },
    { id: 'mistralai/mistral-small-2603',                provider: 'Mistral',   name: 'Mistral Small 4',        speed: '⚡⚡ Rapide',        input: 0.15,  output: 0.60,  quality: 4, french: 3, recommended: true,  note: 'Dernière génération Mistral Small, optimisé multilingue' },
    ...
    { id: 'google/gemini-2.5-flash',                    provider: 'Google',    name: 'Gemini 2.5 Flash',       speed: '⚡⚡ Rapide',        input: 0.30,  output: 2.50,  quality: 4, french: 2, recommended: true,  note: 'Rapide, contexte 1M tokens, bon rapport qualité/prix' },
    { id: 'google/gemini-3.5-flash',                    provider: 'Google',    name: 'Gemini 3.5 Flash',       speed: '⚡⚡ Rapide',        input: 1.50,  output: 9.00,  quality: 5, french: 2, recommended: true,  note: 'Génération Gemini Flash la plus récente, qualité supérieure' },
    ...
    { id: 'mistralai/mistral-large-2512',               provider: 'Mistral',   name: 'Mistral Large 2512',     speed: '⚡⚡ Rapide',        input: 0.50,  output: 1.50,  quality: 5, french: 3, recommended: true,  note: 'Flagship Mistral, excellent français, redevenu économique' },
    { id: 'x-ai/grok-4.3',                              provider: 'xAI',       name: 'Grok 4.3',               speed: '⚡⚡ Rapide',        input: 1.25,  output: 2.50,  quality: 5, french: 2, recommended: true,  note: 'Dernier modèle xAI, raisonnement avancé, à benchmarker en FR' },
    ...
    { id: 'google/gemma-3-27b-it',                      provider: 'Google',    name: 'Gemma 3 27B',            speed: '⚡⚡ Rapide',        input: 0.08,  output: 0.16,  quality: 3, french: 2, recommended: false, note: 'Open source, extrêmement économique' },
    { id: 'microsoft/phi-4',                            provider: 'Microsoft', name: 'Phi-4',                  speed: '⚡⚡⚡ Très rapide', input: 0.07,  output: 0.14,  quality: 3, french: 2, recommended: false, note: 'Petit modèle Microsoft, très bon marché' },
    { id: 'deepseek/deepseek-v3.2',                     provider: 'DeepSeek',  name: 'DeepSeek V3.2',          speed: '⚡⚡ Rapide',        input: 0.23,  output: 0.34,  quality: 4, french: 2, recommended: false, note: 'Dernière version, qualité proche GPT-4o' },    { id: 'deepseek/deepseek-chat',                     provider: 'DeepSeek',  name: 'DeepSeek V3',            speed: '⚡⚡ Rapide',        input: 0.20,  output: 0.80,  quality: 4, french: 2, recommended: false, note: 'Très bon pour le prix' },
    { id: 'meta-llama/llama-3.3-70b-instruct',          provider: 'Meta',      name: 'Llama 3.3 70B',          speed: '⚡⚡ Rapide',        input: 0.10,  output: 0.32,  quality: 4, french: 2, recommended: false, note: 'Open source, bonne qualité' },
    ...
    { id: 'google/gemini-2.5-pro',                      provider: 'Google',    name: 'Gemini 2.5 Pro',         speed: '⚡ Modéré',         input: 1.25,  output: 10.00, quality: 5, french: 2, recommended: false, note: 'Gemini Pro éprouvé, bon compromis qualité/prix' },
    { id: 'qwen/qwen-2.5-72b-instruct',                 provider: 'Alibaba',   name: 'Qwen 2.5 72B',           speed: '⚡ Modéré',         input: 0.36,  output: 0.40,  quality: 3, french: 2, recommended: false, note: 'Alternatif économique' },
