...
const MODELS = [
    ...
    { id: 'mistralai/mistral-small-3.2-24b-instruct',   provider: 'Mistral',   name: 'Mistral Small 4',        speed: '⚡⚡ Rapide',        input: 0.10,  output: 0.30,  quality: 4, french: 3, recommended: true,  note: 'Dernière génération Mistral Small, optimisé multilingue' },
