...
const MODELS = [
    ...
    { id: 'deepseek/deepseek-v3.2',                     provider: 'DeepSeek',  name: 'DeepSeek V3.2',          speed: '⚡⚡ Rapide',        input: 0.23,  output: 0.34,  quality: 4, french: 2, recommended: false, note: 'Dernière version, qualité proche GPT-4o' },
    ...
    { id: 'deepseek/deepseek-chat',                     provider: 'DeepSeek',  name: 'DeepSeek V3',            speed: '⚡⚡ Rapide',        input: 0.20,  output: 0.80,  quality: 4, french: 2, recommended: false, note: 'Très bon pour le prix' },
